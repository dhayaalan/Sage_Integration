...
const ToastMessage = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement() {
  ...
  const components = ["fw-toast-message", "fw-icon", "fw-spinner"];
...
export { ToastMessage as T, defineCustomElement as d };
