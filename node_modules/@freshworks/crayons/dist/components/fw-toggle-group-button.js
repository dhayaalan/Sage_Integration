...
const ToggleGroupButton = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return toggleGroupButtonCss; }
}, [1, "fw-toggle-group-button", {
    "selected": [1540],
    "disabled": [1540],
    "baseClassName": [1025, "base-class-name"],
    "type": [1],
    "selectable": [4],
    "isCheckbox": [4, "is-checkbox"],
    "index": [2],
    "value": [1],
    "header": [1],
    "description": [1],
    "name": [1],
    "setFocus": [64]
  }, [[0, "click", "listenClickHandler"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["fw-toggle-group-button", "fw-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "fw-toggle-group-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ToggleGroupButton);
      }
      break;
    case "fw-icon":
      if (!customElements.get(tagName)) {
...
const FwToggleGroupButton = ToggleGroupButton;
const defineCustomElement = defineCustomElement$1;

export { FwToggleGroupButton, defineCustomElement };
