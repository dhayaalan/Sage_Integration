...
const ProgressLoader = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["fw-progress-loader"];
  components.forEach(tagName => { switch (tagName) {
    case "fw-progress-loader":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ProgressLoader);
      }
      break;
  } });
}
...
const FwProgressLoader = ProgressLoader;
const defineCustomElement = defineCustomElement$1;

export { FwProgressLoader, createProgressLoaderContainer as c, defineCustomElement };
