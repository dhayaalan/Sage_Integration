...
const ToggleGroupButton = class {
  constructor(hostRef) {
    ...
    this.fwToggled = index.createEvent(this, "fwToggled", 7);
    /**
  ...
  render() {
    ...
    return (index.h(index.Host, { tabIndex: '-1' }, strBtnType === 'card' && (index.h("button", { ref: (button) => (this.button = button), class: strButtonClassName, "aria-disabled": this.disabled }, index.h("label", { class: `${strComponentClassName}-header` }, this.header), this.description && this.description !== '' && (index.h("p", { class: `${strComponentClassName}-description` }, this.description)), this.selected ? (index.h("span", { class: `${strComponentClassName}-tick` }, index.h("fw-icon", { size: 10, name: 'check', color: '#FFFFFF', library: 'system' }))) : (''))), strBtnType === 'icon' && (index.h("button", { ref: (button) => (this.button = button), class: strButtonClassName, "aria-disabled": this.disabled }, index.h("slot", { name: 'toggle-icon' }))), strBtnType === 'custom' && index.h("slot", null)));
  }
  get host() { return index.getElement(this); }
};
ToggleGroupButton.style = toggleGroupButtonCss;

exports.fw_toggle_group_button = ToggleGroupButton;
