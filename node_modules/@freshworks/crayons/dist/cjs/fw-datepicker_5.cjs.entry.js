...
const Datepicker = class {
  ...
  renderNavButtons() {
    return (index.h("div", { class: 'btns' }, index.h("div", { class: 'mdpch-button' }, index.h("div", { role: 'button', tabindex: '0', class: `mdpchb-inner ${this.isMinYearRestricted && 'disabled'}`, onClick: () => this.setMonth(-1), onKeyDown: index$1.handleKeyDown(() => this.setMonth(-1)) }, index.h("span", { class: 'mdpchbi-left-arrow' }))), index.h("div", { class: 'mdpch-button-right' }, index.h("div", { role: 'button', tabindex: '0', class: `mdpchb-inner ${this.isMaxYearRestricted && 'disabled'}`, onClick: () => this.setMonth(1), onKeyDown: index$1.handleKeyDown(() => this.setMonth(1)) }, index.h("span", { class: 'mdpchbi-right-arrow' })))));
  }
  renderSupportedYears() {
    return this.supportedYears.map((year, i) => (index.h("fw-select-option", { value: year, key: i, selected: +year === +this.year }, year)));
  }
  renderFooter() {
  ...
  renderTimePicker() {
    return (index.h("div", { class: 'time-container' }, index.h("div", null, index.h("span", null, Translation.TranslationController.t('datepicker.date')), index.h("fw-input", { placeholder: this.dateFormat, value: this.getDate(), readonly: true })), index.h("div", null, index.h("span", null, Translation.TranslationController.t('datepicker.time')), index.h("fw-timepicker", Object.assign({ class: 'mdc-time', sameWidth: false, locale: this.locale, caret: false, optionsPlacement: 'bottom-end', format: this.timeFormat, value: this.timeValue, allowDeselect: false }, this.timeProps)))));
  }
  render() {
    ...
    return (index.h(fieldControl.FieldControl, { inputId: this.name, label: this.label, labelId: `${this.label}-${this.name}`, state: this.state, hintTextId: `hint-${this.name}`, hintText: this.hintText, hasHintTextSlot: this.hasHintTextSlot, errorTextId: `error-${this.name}`, errorText: this.errorText, hasErrorTextSlot: this.hasErrorTextSlot, warningTextId: `warning-${this.name}`, warningText: this.warningText, hasWarningTextSlot: this.hasWarningTextSlot, required: this.required }, index.h("fw-popover", { "same-width": 'false', distance: '8', placement: 'bottom-start', fallbackPlacements: ['top-start'], "hide-on-tab": 'false', onFwHide: this.handlePopoverClose, hoist: true }, index.h("div", { role: 'combobox', "aria-controls": 'datepicker', "aria-expanded": this.showDatePicker, tabindex: '-1', onClick: () => !this.disabled && (this.showDatePicker = true), onKeyUp: () => !this.disabled && (this.showDatePicker = true), slot: 'popover-trigger', style: {
        display: 'inline-flex',
        alignItems: 'center',
      } }, index.h("fw-input", { value: this.value, name: this.name, class: (this.mode === 'range' ? 'range-' : '') + 'date-input', disabled: this.disabled, placeholder: this.placeholder, required: this.required, onFwBlur: this.onBlur, ref: (el) => (this.nativeInput = el), state: this.state, readonly: this.showTimePicker || this.readonly, clearInput: this.clearInput, onFwInputClear: this.handleInputClear }, index.h("div", { class: 'icon-calendar', slot: 'input-suffix' }, index.h("div", { class: 'separator', style: {
        ...
        text: month,
      })), allowDeselect: false, boundary: this.popoverContentElement })), index.h("span", { class: 'mdpchc-year' }, index.h("fw-select", { class: 'last single-year-selector', value: this.year, "same-width": 'false', "options-placement": 'bottom-start', variant: 'button', "allow-deselect": 'false', boundary: this.popoverContentElement }, this.renderSupportedYears()))), this.renderNavButtons()), index.h("div", { class: 'mdpc-body' }, this.renderCalendar(this.monthDetails))), this.showFooter && this.renderFooter())) : (''), this.showDateRangePicker() ? (index.h("div", { id: 'datepicker', class: 'daterangepicker', slot: 'popover-content', ref: (el) => (this.popoverContentElement = el) }, index.h("div", { class: 'mdp-range-container' }, index.h("div", { class: 'mdpc-head' }, index.h("div", { class: 'mdpch-container' }, index.h("span", { class: 'mdpchc-month' }, index.h("fw-select", { class: 'first from-month-selector', value: this.shortMonthNames[this.month], "same-width": 'false', variant: 'button', "options-placement": 'bottom-start', options: this.longMonthNames.map((month, i) => ({
        value: this.shortMonthNames[i],
        key: i,
        selected: month === this.longMonthNames[this.month],
        text: month,
      })), allowDeselect: false, boundary: this.popoverContentElement })), index.h("span", { class: 'mdpchc-year' }, index.h("fw-select", { class: 'last from-year-selector', value: this.year, "same-width": 'false', "options-placement": 'bottom-start', variant: 'button', "allow-deselect": 'false', boundary: this.popoverContentElement }, this.renderSupportedYears()))), index.h("div", { class: 'mdpch-container-right' }, index.h("span", { class: 'mdpchc-month' }, index.h("fw-select", { class: 'first to-month-selector', "same-width": 'false', variant: 'button', value: this.shortMonthNames[this.toMonth], "options-placement": 'bottom-start', options: this.longMonthNames.map((month, i) => ({
        value: this.shortMonthNames[i],
        key: i,
        selected: month === this.longMonthNames[this.toMonth],
        text: month,
      })), allowDeselect: false, boundary: this.popoverContentElement })), index.h("span", { class: 'mdpchc-year' }, index.h("fw-select", { class: 'last to-year-selector', value: this.toYear, "same-width": 'false', "options-placement": 'bottom-start', variant: 'button', "allow-deselect": 'false', boundary: this.popoverContentElement }, this.renderSupportedYears()))), this.renderNavButtons()), index.h("div", { class: 'body-container' }, index.h("div", { class: 'mdpc-body' }, this.renderCalendar(this.monthDetails)), index.h("div", { class: 'mdpc-body mdpc-body-right' }, this.renderCalendar(this.nextMonthDetails)))), this.showFooter && this.renderFooter())) : (''))));
  }
