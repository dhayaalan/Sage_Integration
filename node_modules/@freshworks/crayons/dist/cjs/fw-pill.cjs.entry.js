...
const Pill = class {
  ...
  render() {
    return (index.h("span", { class: this.getPillClass(this.color) }, this.hasIcon && (index.h("div", { class: 'pill-icon' }, index.h("slot", { name: 'icon' }))), index.h("slot", { onSlotchange: () => this.handleSlotChange() })));
  }
  get el() { return index.getElement(this); }
};
Pill.style = pillCss;

exports.fw_pill = Pill;
