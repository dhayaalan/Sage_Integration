...
const Form = class {
  ...
  render() {
    ...
    return (index.h("form", Object.assign({ id: `form-${this.formId}` }, utils.formProps), this.formSchemaState &&
      ...
      return (this.shouldRenderFormControl(field) && (index.h("fw-form-control", { key: field.name, name: field.name, type: field.type, label: field.label, required: field.required, hint: field.hint, placeholder: field.placeholder, choices: field.choices, fieldProps: field, controlProps: utils, disabled: this.isDisabledField(field) })));
