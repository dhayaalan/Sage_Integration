...
const MenuItem = class {
  ...
  render() {
    return (index.h("div", { class: { 'menu-item': true, 'selected': this.selected }, role: 'menuitem', tabIndex: -1, onMouseDown: () => {
        this.selectable && this.toggleSelect();
      } }, index.h("span", { class: 'menu-item__prefix' }, index.h("slot", { name: 'prefix' })), index.h("span", { class: 'menu-item__label' }, index.h("slot", null)), index.h("span", { class: 'menu-item__suffix' }, index.h("slot", { name: 'suffix' })), this.selectable && (index.h("span", { class: 'menu-item__check' }, index.h("fw-icon", { name: 'check', size: 12, color: '#2C5CC5', library: 'system' })))));
  }
  get el() { return index.getElement(this); }
};
MenuItem.style = menuItemCss;

exports.fw_menu_item = MenuItem;
