...
const indexD2a6c100 = require('./index-d2a6c100-3fffbcd3.js');
require('./_rollupPluginBabelHelpers-ef57da83-c706d7df.js');
...
var lastWeekFormatToken = function lastWeekFormatToken(dirtyDate, baseDate, options) {
  var date = indexD2a6c100.toDate(dirtyDate);
  var day = date.getUTCDay();

  if (indexD2a6c100.isSameUTCWeek(date, baseDate, options)) {
    return thisWeek(day);
  } else {
    return lastWeek(day);
  }
