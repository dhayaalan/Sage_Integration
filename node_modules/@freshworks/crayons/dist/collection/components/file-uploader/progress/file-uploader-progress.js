...
export class FileUploaderProgress {
  ...
  render() {
    ...
    return (h("div", { class: 'progress-content' },
      h("div", { class: 'progress-content-icon' },
        h("svg", { width: '26', height: '26', viewBox: '0 0 26 26', fill: 'none', xmlns: 'http://www.w3.org/2000/svg' },
          h("rect", { width: '26', height: '26', fill: 'url(#pattern0)' }),
          h("defs", null,
            h("pattern", { id: 'pattern0', patternContentUnits: 'objectBoundingBox', width: '1', height: '1' },
              h("use", { xlinkHref: '#image0_1441_50556', transform: 'scale(0.00195312)' })),
      ...
      h("div", { class: 'progress-content-file' },
        h("div", { class: 'progress-content-file-name' }, this.fileName),
        h("div", { class: 'progress-content-file-percentage' }, hasError ? (h("fw-icon", { size: 10, name: 'sync', color: '#2c5cc5', onClick: () => this.retryFileUpload(this.fileId) })) : (this.progress + '%')),
        h("div", { class: 'progress-content-progress-bar' },
          h("div", { class: 'progress-content-progress-bar-fill', style: {
              width: hasError ? '0%' : this.progress + '%',
            } })),
        hasError && h("div", { class: 'progress-content-error' }, this.error))));
  }
  static get is() { return "fw-file-uploader-progress"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() { return {
    "$": ["file-uploader-progress.scss"]
  }; }
  static get styleUrls() { return {
    "$": ["file-uploader-progress.css"]
  }; }
  static get properties() { return {
    ...
    "error": {
      ...
      "docs": {
        "tags": [],
        "text": "error text for the file upload"
      },
      "attribute": "error",
      "reflect": false,
      "defaultValue": "''"
  ...
  static get events() { return [{
      ...
      "docs": {
        "tags": [],
        "text": "retryUpload event to emit in case of a retry"
      },
      "complexType": {
        "original": "any",
        "resolved": "any",
